...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      br(), 
      sliderInput("years", label = h3("Year Range"), min = 2010, max = 2017, value = c(2010, 2017)), 
...
# shiny::runApp("D:/6111/REcol/shiny/climate_diagram")
# shiny::runApp("D:/6111/REcol/shiny/climate_diagram", display.mode = "showcase")
